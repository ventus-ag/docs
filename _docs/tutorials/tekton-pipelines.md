...
---
# Configuring Tekton Pipelines, Dashboard and Webhooks extension
{: .no_toc }
---

{% include alert.html type="info" title="Tekton is a Kubernetes-native pipeline resource" content="The Tekton Pipelines project provides Kubernetes-style resources for declaring CI/CD-style pipelines. In this tutorial we will use pipelines, dashboard and webhooks extension to configure automatic build and deployment with your GitHub repository." %}
...
{% include alert.html type="info" title="Keypair" content="You need to provide keypair which will be used for the cluster. If you didn't have one, you can create new using this Core Tasks - SSH Keys **NEED TO ADD URL HERE**" %}
...
![](../../assets/img/tutorials/tekton-pipelines/get_openrc_file_1.png)
  - Select region and hit **GET FILE**
![](../../assets/img/tutorials/tekton-pipelines/get_openrc_file_2.png)
...
`openstack coe cluster config tekton`

7) Export path to created config for as KUBECONFIG env variable:
`export KUBECONFIG=/home/stepan/config`
...
---
{% include alert.html type="info" title="Note:" content="All installations are done via cli using kubectl. Open your ssh client and run next commands to install all necessary products." %}
...
2) Use existing repository which you want to test or use fork version of mine:
  - Go to https://github.com/TenSt/simple-app (this is also a fork of mchmarny/simple-app, but with my changes).
